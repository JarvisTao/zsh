# The content of ~/.fzf.zsh
# Setup fzf
# ---------
# Add fzf to $PATH
if [[ ! "$PATH" == */home/jarvis/.fzf/bin* ]]; then
  export PATH="${PATH:+${PATH}:}/home/jarvis/.fzf/bin"
fi
# Auto-completion
# ---------------
[[ $- == *i* ]] && source "/home/jarvis/.fzf/shell/completion.zsh" 2> /dev/null

# Key bindings
# ------------
source "/home/jarvis/.fzf/shell/key-bindings.zsh"
...
export fzf_preview_cmd='[[ $(file --mime {}) =~ binary ]] && echo {} is aaaaaa binary file || ( cat {}) 2> /dev/null '
